    ...
    <div :class="['wrapper', handleClick1===true ? 'animate-signIn' : ' ' && handleClick2===false ? 'animate-signUp' : ' ']">
        <div class="form-wrapper sign-up">
            <form action="">
                ...
                <div class="sign-link">
                    <p>Ya tienes cuenta? <a @click="handleClick1=!handleClick1 ; handleClick2=!handleClick2" href="#" class="signIn-link">Ingresa por aqui</a></p>
                </div>
            </form>
        </div>
        ...
        <div class="form-wrapper sign-in">
            <form action="">
                ...
                <div class="sign-link">
                    <p>Aun no te registras? <a @click="handleClick1=!handleClick1 ; handleClick2=!handleClick2" href="#" class="signUp-link">Click aqui</a></p>
                </div>
            </form>
        </div>
    </div>
